...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = array_merge($permissions, [
            ...
            'profile_delete',
            'profile_list',
            'profile_manage_privacy',
        ]);

        // Connection Permissions
        $permissions = array_merge($permissions, [
           'connection_send_invite',
           'connection_accept_invite',
           'connection_remove',
           'connection_list',
        ]);
        ...
        $permissions = array_merge($permissions, [
            ...
            'welink_page_delete',
            'welink_page_list',
            'welink_page_manage_content',
            'welink_page_view_analytics',
        ]);
        ...
        // Permissions cho các nhóm trong welink
         $permissions = array_merge($permissions, [
            ...
            'welink_group_delete',
            'welink_group_list',
            'welink_group_manage_member',
            'welink_group_manage_content',
        ]);
        ...
        $adminRole->givePermissionTo([
             'profile_view', 'profile_update', 'profile_list', 'profile_manage_privacy',
            'post_create', 'post_view', 'post_update', 'post_delete','post_list','post_comment','post_like','post_share',
            'skill_add', 'skill_view', 'skill_edit', 'skill_remove','skill_list',
            'connection_send_invite', 'connection_accept_invite', 'connection_remove', 'connection_list',
             'follow_user','unfollow_user','list_followers',
            'welink_page_create', 'welink_page_view', 'welink_page_update', 'welink_page_delete', 'welink_page_list', 'welink_page_manage_content', 'welink_page_view_analytics',
            'welink_group_create', 'welink_group_view', 'welink_group_update', 'welink_group_delete', 'welink_group_list', 'welink_group_manage_member', 'welink_group_manage_content',
             'message_send', 'message_view', 'message_reply','message_delete',
             'settings_manage', 'report_view', 'dashboard_view',
            'user_view', 'user_update', 'user_list', 'user_manage_roles'
        ...
        $contentCreatorRole->givePermissionTo([
           'profile_view',
            'post_create', 'post_view', 'post_update','post_list','post_comment','post_like','post_share',
            'skill_view',
             'welink_page_view', 'welink_page_list','welink_page_manage_content',
             'welink_group_view',  'welink_group_list','welink_group_manage_content'
        ]);
        ...
        $moderatorRole->givePermissionTo([
             'post_view', 'post_update','post_list','post_comment',
            'skill_view',
            'welink_page_view', 'welink_page_list','welink_page_manage_content',
            'welink_group_view', 'welink_group_list','welink_group_manage_content','welink_group_manage_member'
        ]);
       ...
       $basicUserRole->givePermissionTo([
           ...
           'post_view','post_list',
           'skill_view',
           'connection_send_invite', 'connection_accept_invite', 'connection_list',
           'follow_user',
           'message_send', 'message_view', 'message_reply',
           'dashboard_view'
       ]);
